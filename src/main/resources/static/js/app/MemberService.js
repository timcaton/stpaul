...
angular.module('stPaul').factory('MemberService',
    ['$localStorage', '$http', '$q', 'urls',
        function ($localStorage, $http, $q, urls) {
            ...
            function loadAllMembers() {
                ...
                $http.get(urls.MEMBER_SERVICE_API)
                    .then(
                        function (response) {
            ...
            function getMember(id) {
                ...
                var deferred = $q.defer();
                $http.get(urls.MEMBER_SERVICE_API + id)
                    .then(
                        function (response) {
            ...
            function createMember(member) {
                ...
                var deferred = $q.defer();
                $http.post(urls.MEMBER_SERVICE_API, member)
                    .then(
                        function (response) {
                            loadAllMembers();
                            deferred.resolve(response.data);
            ...
            function updateMember(member, id) {
                ...
                var deferred = $q.defer();
                $http.put(urls.MEMBER_SERVICE_API + id, member)
                    .then(
                        function (response) {
                            loadAllMembers();
                            deferred.resolve(response.data);
            ...
            function removeMember(id) {
                ...
                var deferred = $q.defer();
                $http.delete(urls.MEMBER_SERVICE_API + id)
                    .then(
                        function (response) {
                            loadAllMembers();
                            deferred.resolve(response.data);
